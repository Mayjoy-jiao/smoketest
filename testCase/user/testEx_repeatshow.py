...
@paramunittest.parametrized(adx_xls[11])
class Repeat_impressions(unittest.TestCase):
    ...
    def testRepeatImpressions(self):
        """
        test body
        :return:
        """
    ...
    def checkPGdb(self):
        ...
        self.sql = "select valid_type,ex_impressions from public.stats where dsp_app_id='148' and ad_type='2' and ad_group_id='28'and ad_channel_id='677' and ad_customer_id='15158' and imp_type= '1' order by timestamp desc"
