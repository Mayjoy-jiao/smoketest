...
class S2spre2(unittest.TestCase):
    ...
    def checkPGdb(self):
        ...
        # self.sql = "select publisher_request from public.stats where ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257' and dsp_app_id='129' order by timestamp desc limit 2"
        # self.cursor = configPG.executeSQL(self.sql)
        # self.result = configPG.get_all(self.cursor)
        # self.assertEqual(self.result[1], (1,))

        self.sql = "select adx_issued,publisher_request from public.pre_imp2_stats where dsp_app_id='129' and ad_type='2' order by timestamp desc limit 1"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_all(self.cursor)
        self.assertEqual(self.result[0], (1,1))

        # self.sql = "select adx_issued,to_dsp_request from public.stats where dsp_app_id='129'and ad_type='2' and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257' order by timestamp DESC"
        # self.cursor = configPG.executeSQL(self.sql)
    ...
    def checkResult(self):
        ...
        self.assertEqual(self.info['ads'][0]['configId'],'adxDsp_129_2')
    ...
    def checkShow(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select impression2 from public.stats where dsp_app_id='129'and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257' order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)

        self.assertEqual(self.result[0], 1)
        self.sql = "select impressions from public.pre_imp2_stats where dsp_app_id='129' and ad_type='2' order by timestamp desc"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        self.assertEqual(self.result[0], 1)
    ...
    def checkClick(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select click from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkDown(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select download_start from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkDowns(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select download_completed from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkInstl(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select install_start from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkOpenexists(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select app_open from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkInsls(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select install_completed from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkOpen(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select app_activated from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkActive2(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select active2 from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkTodsprequest(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select c2s_dsp_request from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
        ...
        self.sql = "select c2s_dsp_request from public.pre_imp2_stats where dsp_app_id='129' and ad_type='2' order by timestamp desc"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        self.assertEqual(self.result[0], 1)
    ...
    def checkDspissued(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select c2s_dsp_issued from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
        ...
        self.sql = "select c2s_dsp_issued from public.pre_imp2_stats where dsp_app_id='129' and ad_type='2' order by timestamp desc"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
        self.assertEqual(self.result[0], 1)
    ...
    def checkPicdownloadstart(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select pic_download_start from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkPicdownloadcompleted(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select pic_download_completed from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkPicdownloadfailed(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select pic_download_failed from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkGiveup(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select give_up from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkUrljump(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select url_jump from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkManualclosebutton(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select menual_close_button from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkAutoclosebutton(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select auto_close_button from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkInstallremindfailed(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select install_remind_failed from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkNewsimpression(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select news_impression from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkNewsclick(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select news_click from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkDownloadfailed(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select download_failed from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def checkInstallfailed(self):
        ...
        time.sleep(1)
        configPG.connectPG("root","aszx","5432","192.168.0.66","adx_report")
        self.sql = "select install_failed from public.stats where dsp_app_id='129' and ad_type='2'and ad_group_id='52'and ad_channel_id='603' and ad_customer_id='14257'order by timestamp DESC"
        self.cursor = configPG.executeSQL(self.sql)
        self.result = configPG.get_one(self.cursor)
        print(self.result)
    ...
    def testS2spre2(self):
        ...
        # set url
        # url = adx_xls[2][3]
        url = "http://adx77:4400/api/v1/adx/2"
        print("第一步：设置url  "+ url)
        ...
        # set params
        json_path = os.path.join(readConfig.proDir, "testFile","json","s2spre2.json")
